...
export const getAllItems = createAsyncThunk("admin/getAllItems", async (_, thunkAPI) => {
  try {
...
export const blockUser = createAsyncThunk("admin/blockUser", async (id, thunkAPI) => {
  try {
...
export const unblockUser = createAsyncThunk("admin/unblockUser", async (id, thunkAPI) => {
  try {
...
export const deleteItem = createAsyncThunk("admin/deleteItem", async (id, thunkAPI) => {
  try {
...
export const updateUserRole = createAsyncThunk("admin/updateUserRole", async ({ userId, role }, thunkAPI) => {
  try {
    return await adminService.updateUserRole({ userId, role }, getToken(thunkAPI));
  } catch (err) {
    return thunkAPI.rejectWithValue(err.response.data.message);
  }
});
